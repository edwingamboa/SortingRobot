...
public class BusquedaAvara extends Algoritmo{
    private PriorityQueue<Nodo> nodos=new PriorityQueue<Nodo>(100,new ComparadorBusquedaAvara());

    public BusquedaAvara(Problema problema){
        super(problema);
    }
